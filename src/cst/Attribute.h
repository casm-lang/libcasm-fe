...
#ifndef _LIBCASM_FE_CST_ATTRIBUTE_H_
#define _LIBCASM_FE_CST_ATTRIBUTE_H_
...
namespace libcasm_fe
{
    namespace CST
    {
        ...
        class SymbolAttribute final : public Attribute
        {
          public:
            using Ptr = std::shared_ptr< SymbolAttribute >;

            SymbolAttribute(
                const Identifier::Ptr& identifier,
                const std::shared_ptr< VariableDefinition >& symbol );

            const std::shared_ptr< VariableDefinition >& symbol( void ) const;
          ...
          private:
            const std::shared_ptr< VariableDefinition > m_symbol;
        };
...
#endif  // _LIBCASM_FE_CST_ATTRIBUTE_H_
