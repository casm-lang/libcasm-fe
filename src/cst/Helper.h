...
#ifndef _LIBCASM_FE_CST_HELPER_H_
#define _LIBCASM_FE_CST_HELPER_H_
    ...
    namespace CST
    {
        ...
        class Initially final : public Helper
        {
          public:
            ...
            Initially( const Token::Ptr& equalToken, const Expression::Ptr& expression );
...
#endif  // _LIBCASM_FE_CST_HELPER_H_
