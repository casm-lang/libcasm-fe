...
#ifndef _LIBCASM_FE_CST_DEFINITION_H_
#define _LIBCASM_FE_CST_DEFINITION_H_

#include <libcasm-fe/cst/Attribute>
#include <libcasm-fe/cst/Helper>
    ...
    namespace CST
    {
        ...
        class DomainDefinition final : public TypeDefinition
        {
          public:
            ...
            DomainDefinition( const Token::Ptr& domainToken, const Type::Ptr& domainType );
        ...
        class BuiltinDefinition final : public TypeDefinition
        {
          public:
            ...
            BuiltinDefinition(
                const Token::Ptr& builtinToken, const RelationType::Ptr& relationType );
...
#endif  // _LIBCASM_FE_CST_DEFINITION_H_
