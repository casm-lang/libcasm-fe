...
#ifndef _LIBCASM_FE_FRAME_SIZE_DETERMINATION_PASS_H_
#define _LIBCASM_FE_FRAME_SIZE_DETERMINATION_PASS_H_
...
#endif  // _LIBCASM_FE_FRAME_SIZE_DETERMINATION_PASS_H_
