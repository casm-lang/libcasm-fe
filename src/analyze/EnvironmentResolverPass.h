...
#ifndef _LIBCASM_FE_ENVIRONMENT_RESOLVER_PASS_H_
#define _LIBCASM_FE_ENVIRONMENT_RESOLVER_PASS_H_
...
namespace libcasm_fe
{
     ...
     */
    class EnvironmentResolverPass final : public libpass::Pass
    {
      public:
        static char id;
...
#endif  // _LIBCASM_FE_ENVIRONMENT_RESOLVER_PASS_H_
