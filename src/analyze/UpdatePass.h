...
#ifndef _LIB_CASMFE_UPDATEPASS_H_
#define _LIB_CASMFE_UPDATEPASS_H_
...
{
    class UpdatePass : public libpass::Pass, public BaseVisitor<bool>
    {
    public:
        static char id;
...
#endif /* _LIB_CASMFE_UPDATEPASS_H_ */
