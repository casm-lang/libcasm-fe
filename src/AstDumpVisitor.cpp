...
void AstDumpVisitor::visit_function_def(
...
bool AstDumpVisitor::visit_function_atom(
...
bool AstDumpVisitor::visit_builtin_atom(
    BuiltinAtom* atom, std::vector< bool >& )
{
...
bool AstDumpVisitor::visit_number_range_atom(
    NumberRangeAtom* atom, bool, bool )
{
