...
#ifndef _LIBCASM_FE_AST_TO_LST_PASS_H_
#define _LIBCASM_FE_AST_TO_LST_PASS_H_
...
{
    /**
       @brief Transforms AST to LST representation
     */
    class AstToLstPass final : public libpass::Pass
    {
      public:
        static char id;
...
#endif  // _LIBCASM_FE_AST_TO_LST_PASS_H_
