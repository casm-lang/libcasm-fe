...
#ifndef _LIBCASM_FE_CST_TO_AST_PASS_H_
#define _LIBCASM_FE_CST_TO_AST_PASS_H_
...
{
    /**
     * @brief Transforms CST to AST representation
     */
    class CstToAstPass final : public libpass::Pass
    {
      public:
        static char id;
...
#endif  // _LIBCASM_FE_CST_TO_AST_PASS_H_
