...
#+begin_src
BehaviorDefinition ::= "behavior" TemplateSymbols Type "=" "{" BehaviorDefinitionList "}"
#+end_src
...
ImplementDefinition ::= "implement" TemplateSymbols Type "=" "{" ImplementDefinitionList "}"
                      | "implement" TemplateSymbols Type "for" Type "=" "{" ImplementDefinitionList "}"
#+end_src
...
DirectCallExpression ::= "this"
                       ...
                       | "template" TemplateSymbols IdentifierPath "(" Terms ")"
#+end_src
