...
#+begin_src
ImplementDefinition ::= "implement" IdentifierPath "for" Identifier "=" "{" ImplementDefinitionList "}"
                      | "implement" Identifier "=" "{" ImplementDefinitionList "}"
#+end_src
...
#+begin_src
StructureLiteral ::= BasicType "(" ")"
#+end_src

#+html: {{page>.:grammar:StructureLiteral&noheader&nofooter}}
