...
#+begin_src
StructureDefinition ::= MaybeTemplate "structure" Identifier "=" "{" StructureDefinitionList "}"
#+end_src
...
#+begin_src
BehaviorDefinition ::= MaybeTemplate "behavior" Type "=" "{" BehaviorDefinitionList "}"
#+end_src
...
#+html: {{page>.:grammar:Template&noheader&nofooter}}
...
#+html: {{page>.:grammar:MaybeTemplate&noheader&nofooter}}


** ImplementDefinition

#+begin_src
ImplementDefinition ::= MaybeTemplate "implement" Type "=" "{" ImplementDefinitionList "}"
                      | MaybeTemplate "implement" Type "for" Type "=" "{" ImplementDefinitionList "}"
#+end_src
...
#+begin_src
DomainDefinition ::= MaybeTemplate "domain" Type
#+end_src
...
#+begin_src
BuiltinDefinition ::= MaybeTemplate "builtin" RelationType
#+end_src
