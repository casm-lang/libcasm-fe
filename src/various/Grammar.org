...
#+begin_src
ImplementDefinition ::= "implement" Identifier "=" "{" ImplementDefinitionList "}"
                      | "implement" IdentifierPath "for" Identifier "=" "{" ImplementDefinitionList "}"
                      | "implement" IdentifierPath "for" "enumeration" "=" "{" ImplementDefinitionList "}"
#+end_src
