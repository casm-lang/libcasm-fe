...
{
    template <>
    struct hash< libcasm_fe::HeadList >;

    template <>
    struct hash< libcasm_fe::value_t >
    {
        size_t operator()( const libcasm_fe::value_t& key ) const;
    };

    template <>
    struct hash< std::vector< libcasm_fe::value_t > >
    {
        static std::hash< libcasm_fe::value_t > hasher;

        size_t operator()(
            const std::vector< libcasm_fe::value_t >& key ) const;
    };
    ...
    struct hash< libcasm_fe::HeadList >
    {
        ...
        size_t operator()( const libcasm_fe::HeadList& key ) const;
    };

    template <>
    struct hash< libcasm_fe::BottomList >
    {
        static std::hash< std::vector< libcasm_fe::value_t > > list_hasher;

        size_t operator()( const libcasm_fe::BottomList& key ) const;
    };

    std::string to_string( const std::vector< libcasm_fe::value_t >& values );
}
