...
: Literal( Node::ID::VALUE_LITERAL, value->type().ptr_type(), properties )
, m_value( value )
{
}
...
: Literal( Node::ID::REFERENCE_LITERAL, type, properties )
...
: Literal( Node::ID::SET_LITERAL, type, properties )
...
ListLiteral::ListLiteral(
    ...
    const libcasm_ir::Properties& properties,
    const Expressions::Ptr& expressions )
: Literal( Node::ID::LIST_LITERAL, type, properties )
, m_expressions( expressions )
{
}
...
: Literal( Node::ID::RANGE_LITERAL, type, properties )
, m_left( left )
, m_right( right )
{
}
...
TupleLiteral::TupleLiteral(
    ...
    const libcasm_ir::Properties& properties,
    const Expressions::Ptr& expressions )
: Literal( Node::ID::TUPLE_LITERAL, type, properties )
, m_expressions( expressions )
{
}
...
: Literal( Node::ID::RECORD_LITERAL, type, properties )
