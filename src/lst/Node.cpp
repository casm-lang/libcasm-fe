...
const libcasm_ir::Type::Ptr& Node::type( void ) const
{
    return m_type;
}

std::string Node::typeDescription( void ) const
{
    if( type() )
    {
...
const libcasm_ir::Properties& Node::properties( void ) const
{
    return m_properties;
}
...
std::string Node::description( void ) const
{
    switch( m_id )
    {
        ...
        case ID::TYPE_CLSTING_EXPRESSION:
        {
