...
#ifndef _LIBCASM_FE_PATH_LOADING_STRATEGY_H_
#define _LIBCASM_FE_PATH_LOADING_STRATEGY_H_

#include <libcasm-fe/import/LoadingStrategy>

namespace libcasm_fe
{
    class PathLoadingStrategy final : public LoadingStrategy
    {
      public:
        explicit PathLoadingStrategy( const std::string& basePath );
...
#endif  // _LIBCASM_FE_PATH_LOADING_STRATEGY_H_
