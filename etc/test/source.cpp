...
TEST( libcasm_fe, source )
{
    ...
    // pm.add< NumericExecutionPass >();
    // pm.setDefaultPass< NumericExecutionPass >();
    // pm.setDefaultPass< AstDumpSourcePass >();
    // pm.setDefaultPass< AstDumpDotPass >();
    pm.setDefaultPass< ConsistencyCheckPass >();
