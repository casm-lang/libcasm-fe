...
# LIBCASM_FE_INCLUDE_DIRS - the package include directories
...
find_library( LIBCASM_FE_LIBRARY
  NAMES libcasm-fe casm-fe
  PATHS ${LIBCASM_FE_PKGCONF_LIBRARY_DIRS}
)

if( LIBCASM_FE_LIBRARY-NOTFOUND )
  find_library( LIBCASM_FE_LIBRARY
    NAMES libcasm-fe libcasm-fe
    PATHS ${LIBCASM_FE_PKGCONF_LIBRARY_DIRS}
    )
endif()

set( LIBCASM_FE_PROCESS_INCLUDES LIBCASM_FE_INCLUDE_DIR )
set( LIBCASM_FE_PROCESS_LIBS     LIBCASM_FE_LIBRARY )

libfind_process( LIBCASM_FE )

if( EXISTS "${LIBCASM_FE_INCLUDE_DIR}" AND
    EXISTS "${LIBCASM_FE_LIBRARY}" AND
    ${LIBCASM_FE_INCLUDE_DIR} AND
    ${LIBCASM_FE_LIBRARY}
    )
